  ...
  return (
    <section className="rounded-xl border border-dashed bg-card p-4 md:p-5">
      ...
      <div className="mt-4 flex flex-wrap gap-4 text-sm">
        <a className="underline underline-offset-4" href="https://replynodes.com/" target="_blank" rel="noreferrer" onClick={() => trackReplynodesCtaClicked("result_footer")}>Build with ReplyNodes</a>
        <a className="underline underline-offset-4" href="https://github.com/replynodes/jev-web-analyzer" target="_blank" rel="noreferrer" onClick={() => trackGithubClicked()}>View source on GitHub</a>
